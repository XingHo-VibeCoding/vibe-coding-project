...
window.Views = (function () {
  ...
  function periodsEditor(containerId, semester) {
    ...
    return [
      ...
      '      <label class="periods__assist-item"><span class="periods__assist-label">每节时长</span> <input type="number" inputmode="numeric" class="periods__num" id="' + containerId + '-dur" min="10" max="180" step="5" value="' + defDur + '"> 分钟</label>',
      '      <label class="periods__assist-item"><span class="periods__assist-label">课间</span> <input type="number" inputmode="numeric" class="periods__num" id="' + containerId + '-gap" min="0" max="120" step="5" value="' + defGap + '"> 分钟</label>',
